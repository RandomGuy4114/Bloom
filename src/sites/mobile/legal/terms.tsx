...
export const pagePath = "/mobile/pages/legal/terms/"
...
export default function MobilePagesLegalTermsPage() {
    return (
        <PageLifecycle {...pageMetadata}>
            <>
    <div className="TOC-Container">
        <h1 style={{ "textAlign": "center" } as CSSProperties}>Bloom Terms Of Service</h1>
    ...
    <div className="TOC-Container">
        ...
        <p>Your use of Bloom is also governed by the <a href="../privacy/index.html">Privacy Policy.</a></p>
