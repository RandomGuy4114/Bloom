...
export const pagePath = "/mobile/pages/communities/communities/"
...
const pageMetadata = {
    ...
    "pagePath": "/mobile/pages/communities/communities/",
    "redirect": null,
    "scripts": [
        {
            "source": "../../../js/i18n.js",
...
export default function MobilePagesCommunitiesCommunitiesPage() {
    return (
