...
export const pagePath = "/mobile/pages/communities/sub-community/";
...
export default function MobileSubCommunityPage() {
  return (
    <PageLifecycle {...pageMetadata}>
      <AppNavigation mobile usernameLabel="Sub-Community" />
        ...
        <div className="feed-container">
          <section className="communities-profile sub-community-profile">
            ...
            <div className="community-page-actions">
              <button id="joinSubcommunityButton" type="button" hidden>Join Sub-Community</button>
              <button id="editSubcommunityButton" type="button" hidden>Edit</button>
              <button id="deleteSubcommunityButton" type="button" hidden>Delete</button>
            </div>
          </section>
          <div id="subcommunityEditor" className="popup-overlay" aria-hidden="true">
            <section className="popup-card" role="dialog" aria-modal="true" aria-labelledby="editSubcommunityTitle">
              ...
              <div className="popup-body sub-community-form">
                <label>Name<input id="editSubcommunityName" maxLength={100} /></label>
                <label>Description<textarea id="editSubcommunityDescription" maxLength={1000} /></label>
          ...
          <section className="feed-updates">
            <input id="searchSubcommunityPosts" type="search" placeholder="Search posts" aria-label="Search sub-community posts" />
            <PostFeed
