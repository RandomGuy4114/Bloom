...
export const pagePath = "/mobile/pages/credits/"
...
export default function MobilePagesCreditsPage() {
    return (
        <PageLifecycle {...pageMetadata}>
            <>
    <div className="TOC-Container">
        <h1 style={{ "textAlign": "center" } as CSSProperties}>Bloom Credits</h1>
        <p style={{ "textAlign": "center" } as CSSProperties}>Last Updated: July 10, 2026</p>
    </div>
    <div className="TOC-Container">
        <h2>Credits</h2>
        <p>We would like to acknowledge the following individuals and organizations for their contributions to the development of Bloom:</p>
