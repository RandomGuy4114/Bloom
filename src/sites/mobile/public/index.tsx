...
export default function MobilePage() {
    ...
    <div className="topbarHome">
        <a className="topbarHomeLink" href="./pages/auth/register/index.html">Sign Up</a>
        <a className="topbarHomeLink" href="./pages/auth/login/index.html">Log In</a>
