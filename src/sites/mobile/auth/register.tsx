...
export const pagePath = "/mobile/pages/auth/register/"
...
const pageMetadata = {
    ...
    "pagePath": "/mobile/pages/auth/register/",
    "redirect": null,
    "scripts": [
        {
            "source": "../../../js/i18n.js",
...
export default function MobilePagesAuthRegisterPage() {
    return (
        <PageLifecycle {...pageMetadata}>
            <>
    <div className="CenterBox">
        <h1 style={{ "textAlign": "center", "marginBottom": "0" } as CSSProperties}>Welcome To Bloom!</h1>
        ...
        <form id="registerForm" className="auth-form">
            ...
            <label className="terms-consent" htmlFor="termsAccepted">
                ...
                <span>I agree to the <a href="../../legal/terms/index.html">Terms of Service</a> and <a href="../../legal/privacy/index.html">Privacy Policy</a>.</span>
            </label>
            <p id="error-message" className="form-error" role="alert" aria-live="polite"></p>
            <button id="LoginButton" type="submit">Sign Up</button>
        </form>
        <p style={{ "fontSize": "15px", "color": "grey" } as CSSProperties}>Already have an account? <a href="../login/index.html">Log in</a></p>
    </div>
