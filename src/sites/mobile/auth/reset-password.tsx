...
export const pagePath = "/mobile/pages/auth/reset-password/"
...
const pageMetadata = {
    ...
    "pagePath": "/mobile/pages/auth/reset-password/",
    "redirect": null,
    "scripts": [
        {
            "source": "../../../js/i18n.js",
...
export default function MobilePagesAuthResetPasswordPage() {
    return (
