...
export const pagePath = "/pages/auth/login/"
...
export default function PagesAuthLoginPage() {
    return (
    ...
    <div className="CenterBox">
        ...
        <p style={{ "fontSize": "15px", "color": "grey" } as CSSProperties}>Don't have an account? <a href="../register/">Sign up</a></p>
    </div>
