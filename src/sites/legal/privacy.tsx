...
export const pagePath = "/pages/legal/privacy/"
...
export default function PagesLegalPrivacyPage() {
    return (
        <PageLifecycle {...pageMetadata}>
            <>

    <InfoPageHead title="The Bloom Project™ Privacy Policy" subtitle="Last Updated July 29, 2026"/>
    ...
    <div className="TOC-Container">
        ...
        <p>Live location is only stored if you explicitly give permission.</p>
    </div>
    ...
    <div className="TOC-Container">
        ...
        <ul>
            ...
            <li>Operate location-based features</li>
    ...
    <div className="TOC-Container">
        ...
        <p>Bloom sends user-submitted text and images to Sightengine for content moderation.</p>
    ...
    <div className="TOC-Container">
        ...
        <p>The minimum age is 13 in the platform, but this may vary by jurisdiction.</p>
    </div>
