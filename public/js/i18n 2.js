...
const spanish = {
  ...
  "Block this user? They will no longer be able to contact you.": "¿Bloquear a este usuario? Ya no podrá contactarte.",
  "Unblock this user?": "¿Desbloquear a este usuario?",
  "Unable to block this user.": "No se pudo bloquear a este usuario.",
  "Unable to unblock this user.": "No se pudo desbloquear a este usuario.",
  "Blocking user…": "Bloqueando usuario…",
  "Unblocking user…": "Desbloqueando usuario…",
  "You blocked this user.": "Bloqueaste a este usuario.",
  "This profile is unavailable.": "Este perfil no está disponible.",
